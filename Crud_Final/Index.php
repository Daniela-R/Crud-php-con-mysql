    ...
    <section id="Formulario" class="container col-6">
        ...
        <form method="POST" class="row g-3" action="Index.php">
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <button type="reset" class="btn btn-outline-danger" name="borrar" id="borrar">Borrar</button>
            </div>
            <div class="col-6">
            ...
            <div class="d-grid gap-2 col-6 mx-auto">
                <button value="enviar" name="enviar" type="submit" class="btn btn-info">Enviar</button>
            </div>          
        </form>
    </section>
        ...
        if (
            ...
            if ($o - $contadorO > 0 || $d - $contadorD > 0) {
                ...
                if ($o - $contadorO <= 0 && $hora === "8 AM") {
                    echo "<div class='alert alert-danger alert-dismissible fade show fixed-top' role='alert'>
                                Ya no te puedes registrar para las ocho 
                                <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                                </div>";
                } else if ($d - $contadorD <= 0 && $hora === "2 PM") {
                    echo "<div class='alert alert-danger alert-dismissible fade show fixed-top' role='alert'>
                                Ya no te puedes registrar para las dos 
                                <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                                </div>";
                } else {
