    ...
    <section id="Formulario" class="container col-6">
        ...
        <form class="row g-3" action="Consultar.php" method="POST" name="from" id="Formulario">
            ...
            <div class="d-grid gap-3 col-2 ">
                <button type="submit" class="btn btn-outline-info" name="consultar" id="consultar">Consultar</button>
            </div>
        </form>
    </section>
                                        ...
                                        <table class='table'>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> 
                                                    <a href='Eliminar.php?id=<?php echo $result->id; ?>'><button type='button' class='btn btn-outline-danger'>Cancelar</button></a>                                                   
                                                    </td>
                                                </tr>
                                            </tbody>  
