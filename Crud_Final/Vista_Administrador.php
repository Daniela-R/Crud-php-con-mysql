...
<body>
    ...
    ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="Formulario_editar.php?id=<?php echo $dato->id; ?>"><button type="button" class="btn btn-outline-info">Editar</button></a>
                                        <a href="Eliminar.php?id=<?php echo $dato->id; ?>"><button type="button" class="btn btn-outline-danger">Eliminar</button></a>
                                    </td>
                                </tr>
                        <?php
                            }
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end m-5 p-5">
            <a href="Excel.php"><button class="btn btn-dark me-md-2" type="button">Descargar Registros</button></a>
        </div>
